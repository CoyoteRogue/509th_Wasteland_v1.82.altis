...
A3W_fnc_setLockState = { (objectFromNetId (_this select 0)) lock (_this select 1) } call mf_compile; // Added for base door
A3W_fnc_hideObjectGlobal = { (objectFromNetId (_this select 0)) hideObjectGlobal (_this select 1) } call mf_compile; // Added for base door
