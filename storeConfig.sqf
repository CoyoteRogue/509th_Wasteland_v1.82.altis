...
[
	...
	["Flare Pistol", "hgun_Pistol_Signal_F", 25]
];
...
[
	...
	["Mk30A HMG .50 Sentry", "B_HMG_01_A_F", 5000, "HIDDEN"], // "A" = Autonomous = Overpowered
	["Mk30A HMG .50 Sentry", "O_HMG_01_A_F", 5000, "HIDDEN"],
	["Mk30A HMG .50 Sentry", "I_HMG_01_A_F", 5000, "HIDDEN"],
	...
	["Mk32A GMG 20mm Sentry", "B_GMG_01_A_F", 10000, "HIDDEN"],
	["Mk32A GMG 20mm Sentry", "O_GMG_01_A_F", 10000, "HIDDEN"],
	["Mk32A GMG 20mm Sentry", "I_GMG_01_A_F", 10000, "HIDDEN"],
...
[
	["Toxic Gas Grenade", "SmokeShellYellow", 250],
...
[
	...
	["7.62mm 10Rnd Mag", "10Rnd_762x51_Mag", 15, "HIDDEN"],
	...
	["7.62mm 150Rnd Box", "150Rnd_762x51_Box", 150, "HIDDEN"],
	["7.62mm 150Rnd Tracer (Green) Box", "150Rnd_762x51_Box_Tracer", 125, "HIDDEN"],
	...
	["40mm Toxic Gas Grenade", "1Rnd_SmokeYellow_Grenade_shell", 250],
...
[
	...
	["MICH (Camo)", "H_HelmetIA_net", 50, "hat", "HIDDEN"],
	["MICH 2 (Camo)", "H_HelmetIA_camo", 50, "hat", "HIDDEN"],
	...
	["Enhanced Combat Helmet (Snake skin)", "H_HelmetSpecB_snakeskin", 75, "hat"],
	...
	["Bandanna (Black)", "H_Bandanna_gry", 10, "hat"],
	["Bandanna (Blue)", "H_Bandanna_blu", 10, "hat"],
	["Bandanna (Coyote)", "H_Bandanna_cbr", 10, "hat"],
	["Bandanna (Headset)", "H_Bandanna_khk_hs", 10, "hat"],
	["Bandanna (Khaki)", "H_Bandanna_khk", 10, "hat"],
	["Bandanna (MTP)", "H_Bandanna_mcamo", 10, "hat"],
	["Bandanna (Sage)", "H_Bandanna_sgg", 10, "hat"],
	["Bandanna (Sand)", "H_Bandanna_sand", 10, "hat"],
	["Bandanna (Surfer)", "H_Bandanna_surfer", 10, "hat"],
	["Bandanna (Surfer, Black)", "H_Bandanna_surfer_blk", 10, "hat"],
	["Bandanna (Surfer, Green)", "H_Bandanna_surfer_grn", 10, "hat"],
	["Bandanna (Woodland)", "H_Bandanna_camo", 10, "hat"],
	["Bandanna Mask (Black)", "H_BandMask_blk", 10, "hat", "HIDDEN"],
	["Bandanna Mask (Demon)", "H_BandMask_demon", 10, "hat", "HIDDEN"],
	["Bandanna Mask (Khaki)", "H_BandMask_khk", 10, "hat"],
	["Bandanna Mask (Reaper)", "H_BandMask_reaper", 10, "hat", "HIDDEN"],
	...
	["Boonie hat (Dirty)", "H_Booniehat_dirty", 10, "hat"],
	...
	["Cap (Police)", "H_Cap_police", 10, "hat", "HIDDEN"],
	["Cap (Press)", "H_Cap_press", 10, "hat", "HIDDEN"],
	...
	["Shemag mask (Tan)", "H_Shemag_tan", 25, "hat", "HIDDEN"],
...
[
	...
	["Guerrilla Garment", "U_BG_Guerilla1_1", 25, "uni"],  // BLUFOR
	["Guerrilla Outfit (Plain, Dark)", "U_BG_Guerilla2_1", 25, "uni"],
	["Guerrilla Outfit (Pattern)", "U_BG_Guerilla2_2", 25, "uni"],
	["Guerrilla Outfit (Plain, Light)", "U_BG_Guerilla2_3", 25, "uni"],
	["Guerrilla Smocks", "U_BG_Guerilla3_1", 25, "uni"],
	["Guerrilla Apparel", "U_BG_Guerrilla_6_1", 25, "uni"],
	["Guerrilla Uniform", "U_BG_leader", 25, "uni"],
	["Guerrilla Garment", "U_OG_Guerilla1_1", 25, "uni"], // OPFOR
	["Guerrilla Outfit (Plain, Dark)", "U_OG_Guerilla2_1", 25, "uni"],
	["Guerrilla Outfit (Pattern)", "U_OG_Guerilla2_2", 25, "uni"],
	["Guerrilla Outfit (Plain, Light)", "U_OG_Guerilla2_3", 25, "uni"],
	["Guerrilla Smocks", "U_OG_Guerilla3_1", 25, "uni"],
	["Guerrilla Apparel", "U_OG_Guerrilla_6_1", 25, "uni"],
	["Guerrilla Uniform", "U_OG_leader", 25, "uni"],
	["Guerrilla Garment", "U_IG_Guerilla1_1", 25, "uni"], // Independent
	["Guerrilla Outfit (Plain, Dark)", "U_IG_Guerilla2_1", 25, "uni"],
	["Guerrilla Outfit (Pattern)", "U_IG_Guerilla2_2", 25, "uni"],
	["Guerrilla Outfit (Plain, Light)", "U_IG_Guerilla2_3", 25, "uni"],
	["Guerrilla Smocks", "U_IG_Guerilla3_1", 25, "uni"],
	["Guerrilla Apparel", "U_IG_Guerrilla_6_1", 25, "uni"],
	["Guerrilla Uniform", "U_IG_leader", 25, "uni"],
	["Worker Coveralls", "U_C_WorkerCoveralls", 25, "uni", "HIDDEN"], // can only be worn by civilian units
	["T-Shirt (Blue)", "U_C_Poor_1", 25, "uni", "HIDDEN"],
	["Polo (Red/white)", "U_C_Poloshirt_redwhite", 25, "uni", "HIDDEN"],
	["Polo (Salmon)", "U_C_Poloshirt_salmon", 25, "uni", "HIDDEN"],
	["Polo (Tri-color)", "U_C_Poloshirt_tricolour", 25, "uni", "HIDDEN"],
	["Polo (Navy)", "U_C_Poloshirt_blue", 25, "uni", "HIDDEN"],
	["Polo (Burgundy)", "U_C_Poloshirt_burgundy", 25, "uni", "HIDDEN"],
	["Polo (Blue/green)", "U_C_Poloshirt_stripped", 25, "uni", "HIDDEN"],
	["Polo (Competitor)", "U_Competitor", 25, "uni"],
	["Polo (Range Master)", "U_Rangemaster", 25, "uni"],
	["Racing Suit (Black)", "U_C_Driver_1_black", 25, "uni", "HIDDEN"], // can only be worn by civilian units
	["Racing Suit (Blue)", "U_C_Driver_1_blue", 25, "uni", "HIDDEN"],
	["Racing Suit (Green)", "U_C_Driver_1_green", 25, "uni", "HIDDEN"],
	["Racing Suit (Yellow)", "U_C_Driver_1_yellow", 25, "uni", "HIDDEN"],
	["Racing Suit (Orange)", "U_C_Driver_1_orange", 25, "uni", "HIDDEN"],
	["Racing Suit (Red)", "U_C_Driver_1_red", 25, "uni", "HIDDEN"],
	["Racing Suit (White)", "U_C_Driver_1_white", 25, "uni", "HIDDEN"],
	["Racing Suit (Fuel)", "U_C_Driver_1", 25, "uni", "HIDDEN"],
	["Racing Suit (Bluking)", "U_C_Driver_2", 25, "uni", "HIDDEN"],
	["Racing Suit (Redstone)", "U_C_Driver_3", 25, "uni", "HIDDEN"],
	["Racing Suit (Vrana)", "U_C_Driver_4", 25, "uni", "HIDDEN"],
...
[
	["Re-breather (NATO)", "V_RebreatherB", 200, "vest"],
	["Re-breather (CSAT)", "V_RebreatherIR", 200, "vest"],
	["Re-breather (AAF)", "V_RebreatherIA", 200, "vest"],
	...
	["Tactical Vest (Police)", "V_TacVest_blk_POLICE", -1, "vest", "HIDDEN"],
...
[
	["Parachute", "B_Parachute", 200, "backpack", "HIDDEN"],
...
[
	...
	["Building (Aircraft Hangar Large)", "Land_Airport_01_hangar_F", 150000, "object"],
	...
	["Camo Net", "CamoNet_INDP_open_F", 500, "object"],
	...
	["Cargo Container", "Land_Cargo20_military_green_F", 20000, "object"],
	...
	["Dome (Small)", "Land_Dome_Small_F", 200000, "object"],
	["Empty Ammo Cache (Camo)", "Box_FIA_Support_F", 250, "ammocrate"],
	...
	["Lamp Post (Harbor)", "Land_LampHarbour_F", 100, "object"],
	["Lamp Post (Harbor)", "Land_LampHarbour_F", 100, "object"],
	["Lamp Post (Shabby)", "Land_LampShabby_F", 100, "object"],
	["Lamp Post (Shabby)", "Land_LampShabby_F", 100, "object"],
	["Landing Platform (Extra Large)", "Land_AirstripPlatform_01_F", 100000, "object"],
	["Landing Platform Fence (Long)", "Land_NetFence_01_m_8m_F", 8000, "object"],
	["Landing Platform Fence (Post)", "Land_NetFence_01_m_pole_F", 1000, "object"],
	["Landing Platform Fence (Short)", "Land_NetFence_01_m_4m_F", 4000, "object"],
	...
	["Luxury Item (Refrigerator)", "Fridge_01_closed_F", 50000, "object"],
	...
	["Platform Sidewalk (Narrow 4M)", "Land_Sidewalk_01_narrow_4m_F", 100, "object"],
	...
	["Scaffolding (Mobile)", "Land_MobileScafolding_01_F", 250, "object"],
	...
	["Tool Trolley", "Land_ToolTrolley_01_F", 250, "object"],
...
[
	...
	["HEMTT Resupply", "B_Truck_01_ammo_F", 25000, "vehicle", "HIDDEN"],
	...
	["Tempest Resupply", "O_Truck_03_ammo_F", 25000, "vehicle", "HIDDEN"],
	...
	["Zamak Resupply", "I_Truck_02_ammo_F", 25000, "vehicle", "HIDDEN"],
...
[
	...
	["CRV-6e Bobcat (Resupply)", "B_APC_Tracked_01_CRV_F", 30000, "vehicle", "HIDDEN"],
...
[
	[ // Main colors
		...
		[
			...
			["509th Camo", _texDir + "509th_camo.jpg"],
			...
			["Red Digi", _texDir + "bloodshot.paa"],
